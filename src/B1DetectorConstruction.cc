...
{
  G4String fileName = FILE_VOXEL_TO_MATERIALS_TEST;
  ...
  //G4String fileName2 = FILE_VOXEL_TO_MATERIALS_TEST;
...
void B1DetectorConstruction::ReadVoxelDensities( std::ifstream& fin )
{
	G4String stemp;
