...
// ********************************************************************
//
/// \file GB01/src/B1BOptrMultiParticleChangeCrossSection.cc
/// \brief Implementation of the B1BOptrMultiParticleChangeCrossSection class
//
#include "B1BOptrMultiParticleChangeCrossSection.hh"
#include "G4BiasingProcessInterface.hh"

#include "B1BOptrChangeCrossSection.hh"
...
B1BOptrMultiParticleChangeCrossSection::B1BOptrMultiParticleChangeCrossSection()
  : G4VBiasingOperator("TestManyExponentialTransform")
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void B1BOptrMultiParticleChangeCrossSection::AddParticle(G4String particleName)
{
  ...
  if ( particle == 0 )
    {
      ...
      G4Exception("B1BOptrMultiParticleChangeCrossSection::AddParticle(...)",
                  "exGB01.02",
                  JustWarning,
                  ed);
      return;
  ...
  B1BOptrChangeCrossSection* optr = new B1BOptrChangeCrossSection(particleName);
...
G4VBiasingOperation*
B1BOptrMultiParticleChangeCrossSection::
...
void B1BOptrMultiParticleChangeCrossSection::StartTracking( const G4Track* track )
{
  ...
  std::map < const G4ParticleDefinition*, B1BOptrChangeCrossSection* > :: iterator
