...
// ********************************************************************
//
/// \file GB01/src/B1BOptrChangeCrossSection.cc
/// \brief Implementation of the B1BOptrChangeCrossSection class
//
...
B1BOptrChangeCrossSection::B1BOptrChangeCrossSection(G4String particleName,
                                                         G4String         name)
  ...
  if ( fParticleToBias == 0 )
    {
      ...
      G4Exception("B1BOptrChangeCrossSection(...)",
                  "exGB01.01",
                  JustWarning,
                  ed);
    }
...
B1BOptrChangeCrossSection::~B1BOptrChangeCrossSection()
{
...
void B1BOptrChangeCrossSection::StartRun()
{
  // --------------
  // -- Setup stage:
  // ---------------
...
G4VBiasingOperation* 
B1BOptrChangeCrossSection::ProposeOccurenceBiasingOperation(const G4Track*            track,
...
void B1BOptrChangeCrossSection::
